...
.display-topleft{background-color: rgb(0,0,0); /* Fallback color */
...
<p>Explore detailed information about various career paths, including  educational requirements, and potential career growth. Whether you're interested in science, arts, technology, or business, we have resources to guide you.
</p>
...
<div class="content" id="Careers">
    ...
    <div class="col m6 margin-bottom">
        ...
        <a href="after10th2.php">
         ...
         <p><b> After Matriculation</b></p><p>Explore your options after 10th grade, including Science, Commerce, Arts, and vocational courses. Learn about the career paths for each stream  to help you decide your next steps.</p>
         </div></a> 
    </div>
    <div class="col m6 margin-bottom">
        <div class="container">
        <a href="afterinter2.php">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6sC6PLucZzL4Z1Raro-Rascg_pHV363C4xg&s" alt="After 10th" style="width:100% ;border-radius:20px 20px 0 0" >
          <p><b> After Intermediate
          </b></p><p>Discover various undergraduate courses, diplomas, and professional programs available after 12th grade. Understand the career opportunities for each stream .
    ...
    <div class="col m6 margin-bottom">
        <div class="container">
        <a href="eligible.php">
          <img src="https://media.licdn.com/dms/image/C5612AQEviJ7_3_DNMw/article-cover_image-shrink_720_1280/0/1606579847797?e=2147483647&v=beta&t=WATKyGLJk-Ja99sgaixU38ddIIP7VIC2O3ndjeSti4A" alt="After 10th" style="width:100% ;height:50% ;border-radius:20px 20px 0 0 ">
     ...
     <div class="col m6 margin-bottom">
        <div class="container">
        <a href="b.php">
          <img src="https://images.theconversation.com/files/181590/original/file-20170809-32183-q3qxf2.jpg?ixlib=rb-4.1.0&q=45&auto=format&w=926&fit=clip" alt="After 10th" style="width:100%;border-radius:20px 20px 0 0">
          <p><b> List of Universities</b></p><p>Explore detailed profiles of universities, including admission requirements and campus life. Search for colleges based on location and courses, and see top colleges for various streams. 
          </p>
         </div></a>
    </div>
</div>
...
<p>As students ourselves, we understand the challenges of planning for the future. We created Academic Navigator to empower fellow students with the tools and knowledge they need to chart their academic journey confidently. Whether you're exploring options in middle school, navigating high school decisions, preparing for entrance tests, or choosing a university, our platform is here to support you every step of the way.
  ...
  <div class="col m6 margin-bottom">
        <div class="container">
          ...
          <img src="3.ananya.jpg" height="400" style="width:100%;border-radius:20px 20px 0 0"><h1>Ananya</h1><br>
        </div>
    </div>
    <div class="col m6 margin-bottom">
        <div class="container">
          
        <img src="mahi.jpg" height="400" style="width:100%;border-radius:20px 20px 0 0"><h1>Mahitha</h1><br>
        </div>
    </div>
    <div class="col m6 margin-bottom">
        <div class="container">
            
        <img src="1.navya.jpg" height="400" style="width:100%;border-radius:20px 20px 0 0"><h1>Navya</h1><br>
        </div>
    </div>
    <div class="col m6 margin-bottom">
        <div class="container">
            
        <img src="2.harinitha.jpg" height="400" style="width:100%;border-radius:20px 20px 0 0"><h1>Harinitha</h1><br>
        </div>
    </div>
...
<div class="content" id="Feedback">
  ...
  <p>We value your feedback and suggestions. Please share your thoughts on how we can improve Academic Navigator.</p>
